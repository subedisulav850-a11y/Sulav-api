                ...
                if data.hex().startswith("120000"):
                    ...
                    if response:
                        ...
                        if inPuTMsG.strip() == "/debug":
                            ...
                            debug_msg = f"[FF0000]✅ NURROSUL BOT ONLINE! UID: {uid}"
...
[FF0000]╠══════════╣
[FFD700]⚡ OWNER : [FFFFFF]NURROSUL    
[FFD700]✨ Name on instagram : [FFFFFF]Hwk_pushpendra❤️  
[FF0000]╚══════════╝
[FFD700]✨ Developer —͟͞͞ </> NURROSUL  ⚡"""
                            else:
                                message = f"""[C][B][FF0000]╔══════════╗
[FFFFFF]✨ folow on Instagram   
[FFFFFF]          ⚡ NURROSUL❤️  
...
[FFD700]✨ Developer —͟͞͞ </> NURROSUL  ⚡"""
                            ...
                            try:
                                ...
                                fallback_msg = "[FF0000]NURROSUL BOT online! Use /help"
                        ...
                        if inPuTMsG.startswith('/stop') and is_admin(uid):
                            ...
                            stop_msg = f"[FF0000]NURROSUL BOT stopping..."
...
async def MaiiiinE():
    ...
    os.system('clear')
    print(render('NURROSUL', colors=['white', 'green'], align='center'))
    print('')
    print(f" - NURROSUL BOT STarTinG And OnLine on TarGet : {TarGeT} | BOT NAME : {acc_name}\n")
    print(f" - BoT sTaTus > GooD | OnLinE ! (:")    
    print(f" - NURROSUL | Bot Uptime: {time.strftime('%H:%M:%S', time.gmtime(time.time() - bot_start_time))}") 
